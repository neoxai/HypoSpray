...
namespace HypoSpray
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(IntroduceInitializeField)), Shared]
    internal class IntroduceInitializeField : CodeRefactoringProvider
    {
